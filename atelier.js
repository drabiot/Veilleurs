(() => {
  ...
  const STAT_GROUPS = [
    {
      ...
      stats: [
        ...
        { id:'degats_competence',   label:'Dégâts de Compétence',            icon:'✨',  unit:'',   max:300  },
  ...
  const ITEMS = [
    ...
    { id:'casque_titan',    name:"Casque du Titan",             set:'titan',    rarity:'rare', cat:'casque',      tier:1, img:"",            stats:{sante:[30,35], defense:[1.2,1.6]}, classes:['guerrier'] },
    { id:'plastron_titan',  name:"Plastron du Titan",           set:'titan',    rarity:'rare', cat:'plastron',    tier:1, img:"",            stats:{sante:[34,38.99], defense:[3.2,3.7]}, classes:['guerrier'] },
    { id:'jambieres_titan', name:"Jambières du Titan",          set:'titan',    rarity:'rare', cat:'jambières',   tier:1, img:"",            stats:{sante:[32,37], defense:[1.4,1.92]}, classes:['guerrier'] },
    { id:'bottes_titan',    name:"Bottes du Titan",             set:'titan',    rarity:'rare', cat:'bottes',      tier:1, img:"",            stats:{sante:[27,31], defense:[0.9,1.4]}, classes:['guerrier'] },
    ...
    { id:'tunique_tacti',   name:"Tunique Tactique",            set:'tactique', rarity:'commun', cat:'plastron',    tier:1, img:"",            stats:{sante:[21,25], defense:0.4}, classes:['assassin','archer'] },
    { id:'jambieres_tacti', name:"Jambières Tactique",          set:'tactique', rarity:'commun', cat:'jambières',   tier:1, img:"",            stats:{sante:[17,21], defense:0.4}, classes:['assassin','archer'] },
    { id:'bottes_tacti',    name:"Bottes Tactique",             set:'tactique', rarity:'commun', cat:'bottes',      tier:1, img:"",            stats:{sante:[15,18], defense:0.3}, classes:['assassin','archer'] },
    { id:'tunique_ninja',   name:"Tunique du Ninja",            set:'ninja',    rarity:'rare', cat:'plastron',    tier:1, img:"",            stats:{sante:[29,34], defense:[1.5,2.3]}, classes:['assassin'] },
    { id:'jambieres_ninja', name:"Jambières du Ninja",          set:'ninja',    rarity:'rare', cat:'jambières',   tier:1, img:"",            stats:{sante:[23,27], defense:[0.9,1.4]}, classes:['assassin'] },
    { id:'bottes_ninja',    name:"Bottines du Ninja",           set:'ninja',    rarity:'rare', cat:'bottes',      tier:1, img:"",            stats:{sante:[18,23], defense:[0.8,1]}, classes:['assassin'] },
    { id:'tunique_chass',   name:"Plastron du Chasseur",        set:'chasseur', rarity:'rare', cat:'plastron',    tier:1, img:"",            stats:{sante:[25,30], defense:[1.3,2]}, classes:['archer'] },
    { id:'jambieres_chass', name:"Jambières du Chasseur",       set:'chasseur', rarity:'rare', cat:'jambières',   tier:1, img:"",            stats:{sante:[20,24], defense:[0.7,1.2]}, classes:['archer'] },
    { id:'bottes_chass',    name:"Bottines du Chasseur",        set:'chasseur', rarity:'rare', cat:'bottes',      tier:1, img:"",            stats:{sante:[16,20], defense:[0.7,0.9]}, classes:['archer'] },
    ...
    { id:'robe_magic',      name:"Robe du Magicien",            set:'magicien', rarity:'rare', cat:'plastron',    tier:1, img:"",            stats:{sante:[27,32], defense:[1.5,2.3]}, classes:['shaman'] },
    { id:'pantalon_magic',  name:"Pantalon du Magicien",        set:'magicien', rarity:'rare', cat:'jambières',   tier:1, img:"",            stats:{sante:[20,24], defense:[0.9,1.4]}, classes:['shaman'] },
    { id:'sandales_magic',  name:"Sandales du Magicien",        set:'magicien', rarity:'rare', cat:'bottes',      tier:1, img:"",            stats:{sante:[14,18.72], defense:[0.7,0.9]}, classes:['shaman'] },
    ...
    { id:'bottes_rev',      name:"Bottes du Revenant",                          rarity:'legendaire', cat:'bottes',  tier:1, img:"img/compendium/textures/weapons/bottes_du_revenant.png",            stats:{vitesse_deplacement:5} },
    { id:'bottes_ecu',      name:"Bottes de l'Écume",                           rarity:'legendaire', cat:'bottes',  tier:1, img:"img/compendium/textures/weapons/bottes_decume.png",            stats:{'Agilité Aquatique':10} },
  ];
  ...
  function itemAllowedForClass(item, classId) {
    ...
    /* Accepte 'classes' ou 'class' (les deux noms de champ sont valides) */
    const list = item.classes || item.class || [];
    if (!list || list.length === 0) return true;         /* pas de restriction */
  ...
  /* Compte combien de pièces de chaque panoplie sont équipées */
  ...
  /* Retourne la liste des bonus actifs sous forme [{statId, min, max}] */
  function computeSetBonuses(setCounts) {
    ...
    Object.entries(setCounts).forEach(function(entry) {
      ...
      if (!setDef) return;
      /* Paliers cumulatifs : si count >= 4 on applique 2, 3 et 4 */
    ...
    return { bonusMins: bonusMins, bonusMaxs: bonusMaxs };
  }
  ...
  function computeStats() {
    ...
    return { mins: mins, maxs: maxs, setCounts: setCounts };
  }
 
  /* Index du set actuellement affiché dans le carousel */
  ...
  function renderSetBonuses(setCounts) {
    ...
    /* Clamper l'index si des sets ont disparu */
    ...
    /* ── Contenu du set courant (masqué si collapsed) ── */
    ...
    Object.entries(setDef.bonuses).forEach(function(b) {
      ...
      Object.entries(stats).forEach(function(sv) {
        ...
        line.innerHTML = '<span class="set-stat-icon">' + icon + '</span>' +
