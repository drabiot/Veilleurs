...
const FLOOR_MARKERS = {
  1: [
    ...
    { id: 'm32', type: 'ressource', emoji: '🌾', gx: 2263, gy: 3706, name: 'Allium',              desc: "", link: '' },
    { id: 'm35', type: 'ressource', emoji: '🌾', gx: 2288, gy: 3653, name: 'Blé',                 desc: "", link: '' },
    { id: 'm36', type: 'ressource', emoji: '🌳', gx: 2846, gy: 3517, name: 'Chêne de Forêt',      desc: "", link: '' },
    { id: 'm38', type: 'ressource', emoji: '🌳', gx: 2357, gy: 4301, name: 'Chêne Proche',        desc: "", link: '' },
    { id: 'm39', type: 'ressource', emoji: '🌳', gx: 1707, gy: 1207, name: 'Bouleau',             desc: "", link: '' },
    { id: 'm40', type: 'ressource', emoji: '⛏️', gx: 2309, gy: 3509, name: 'Charbon Petite Cave', desc: "", link: '' },
    { id: 'm41', type: 'ressource', emoji: '⛏️', gx: 2309, gy: 3509, name: 'Cuivre Petite Cave',  desc: "", link: '' },
    { id: 'm42', type: 'ressource', emoji: '⛏️', gx: 2309, gy: 3509, name: 'Fer Petite Cave',     desc: "", link: '' },
    { id: 'm43', type: 'ressource', emoji: '⛏️', gx: 903,  gy: 3448, name: 'Charbon Grande Cave', desc: "", link: '' },
    { id: 'm44', type: 'ressource', emoji: '⛏️', gx: 903,  gy: 3448, name: 'Cuivre Grande Cave',  desc: "", link: '' },
    { id: 'm45', type: 'ressource', emoji: '⛏️', gx: 903,  gy: 3448, name: 'Fer Grande Cave',     desc: "", link: '' },

    { id: 'm46', type: 'artisant',  gx: 1703, gy: 4125, name: "Forgeron d'Armes",                 desc: "Forgeron des Armes pour Débutants", link: '' },
    { id: 'm47', type: 'artisant',  gx: 1703, gy: 4125, name: "Forgeron d'Armures",               desc: "Forgeron des Armures pour Débutants", link: '' },
    { id: 'm48', type: 'artisant',  gx: 1703, gy: 4125, name: "Forgeron d'Accessoires",           desc: "Forgeron des Accessoires pour Débutants", link: '' },
    { id: 'm49', type: 'artisant',  gx: 1721, gy: 4605, name: 'Marchand Étrange',                 desc: "Marchand suspect trainant derrière la Cathédrale", link: '' },
    { id: 'm50', type: 'artisant',  gx: 1725, gy: 4729, name: "Forgeron d'Accessoires en Cuivre", desc: "Forgeron des Accessoires en Cuivre pour Débutants", link: '' },
    { id: 'm51', type: 'artisant',  gx: 1725, gy: 4729, name: "Forgeron d'Accessoires en Fer",    desc: "Forgeron des Accessoires en Fer pour Débutants", link: '' },
    { id: 'm52', type: 'artisant',  gx: 1725, gy: 4729, name: 'Refaçonneur',                      desc: "Permet la fabrication de ficelle en tout genre et tout type de matériaux", link: '' },
    { id: 'm53', type: 'artisant',  gx: 2322, gy: 3560, name: 'Forgeron de Lingots',              desc: "Forgeron de Lingots de Cuivre et de Fer", link: '' },
    { id: 'm54', type: 'artisant',  gx: 3193, gy: 1474, name: "Forgeron d'Armes",                 desc: "Forgeron des Armes pour Confirmés", link: '' },
    { id: 'm55', type: 'artisant',  gx: 2355, gy: 2412, name: "Forgeron d'Armes",                 desc: "Forgeron d'Armes du Donjon du Labyrinthe des Déchus", link: '' },
    { id: 'm56', type: 'artisant',  gx: 2355, gy: 2412, name: "Forgeron d'Armures",               desc: "Forgeron d'Armures situé à l'intérieur du Donjon du Labyrinthe des Déchus", link: '' },
    { id: 'm57', type: 'artisant',  gx: 2394, gy: 4293, name: 'Bucheron',                         desc: "Bucheron permettant la Réalisation de Planches ou de Poudre de différents type de Bois", link: '' },
    { id: 'm58', type: 'artisant',  gx: 1712, gy: 4091, name: 'Alchimiste',                       desc: "Alchimiste permettant la Réalisation de Potions et Cristaux", link: '' },

    { id: 'm59', type: 'repreneur_butin', gx: 1720, gy: 4170, name: 'Repreneur des Débutants',  desc: "Achète des ressources digne d'un Débutant", link: '' },
    { id: 'm60', type: 'repreneur_butin', gx: 1446, gy: 3415, name: 'Repreneur de la Forêt',    desc: "Achète des ressources de la Forêt", link: '' },
    { id: 'm61', type: 'repreneur_butin', gx: 3074, gy: 3678, name: 'Repreneur Champêtre',      desc: "Achète des ressources des Champs", link: '' },
    { id: 'm62', type: 'repreneur_butin', gx: 363,  gy: 3092, name: 'Repreneur des Maraicages', desc: "Achète des ressources Gluantes", link: '' },
    { id: 'm63', type: 'repreneur_butin', gx: 1541, gy: 1983, name: 'Repreneur des Mers',       desc: "Achète des ressources Maritimes", link: '' },
    { id: 'm64', type: 'repreneur_butin', gx: 2764, gy: 4680, name: 'Repreneur de Squelette',   desc: "Achète des ressources digne d'un Débutant", link: '' },

    { id: 'm65', type: 'marchand', gx: 1720, gy: 4147, name: "Marchand d'Équipement", desc: "Vends des Armes et objets pour les Nouveaux Arrivants", link: '' },
    { id: 'm66', type: 'marchand', gx: 1447, gy: 3390, name: "Marchand d'Équipement", desc: "Vends des Armes et objets pour les Nouveaux Arrivants", link: '' },
    { id: 'm67', type: 'marchand', gx: 438,  gy: 3077, name: "Marchand d'Accessoires", desc: "Vends des Accessoires Gluants", link: '' },
    { id: 'm68', type: 'marchand', gx: 1750, gy: 4147, name: "Marchand d'Outils",      desc: "Vends des outils pour récolter des matières premières pour les Nouveaux Arrivants", link: '' },
    { id: 'm69', type: 'marchand', gx: 1537, gy: 1958, name: "Marchand d'Outils",      desc: "Vends des outils pour récolter des matières premières pour les Nouveaux Arrivants", link: '' },

    { id: 'm70', type: 'clef', emoji: '🗝️', gx: 1750, gy: 4170, name: 'Clef du Donjon Mine de Geldorak',      desc: "Clef permettant d'ouvrir la porte du Donjon des Mines de Geldorak",     link: '' },
    { id: 'm71', type: 'clef', emoji: '🗝️', gx: 4210, gy: 3895, name: 'Clef du Donjon Mine de Geldorak',      desc: "Clef permettant d'ouvrir la porte du Donjon des Mines de Geldorak",     link: '' },
    { id: 'm72', type: 'clef', emoji: '🗝️', gx: 2314, gy: 2435, name: 'Clef du Donjon Labyrinthe des Déchus', desc: "Clef permettant d'ouvrir la porte du Donjon du Labyrinthe des Déchus", link: '' },
    { id: 'm73', type: 'clef', emoji: '🗝️', gx: 955,  gy: 1212, name: "Clef du Donjon Xal'Zirith",            desc: "Clef permettant d'ouvrir la porte du Donjon Xal'Zirith",                link: '' },

    { id: 'm74', type: 'clef', emoji: '💍', gx: 4128, gy: 1823, name: "Fabricant Secret de l'Ours",      desc: "Permet la confection Secrète du Bracelet de Glace",     link: '' },
    { id: 'm75', type: 'clef', emoji: '💍', gx: 1267, gy: 2140, name: 'Fabricant Secret du Léviathan',   desc: "Permet la confection Secrète de l'Anneau du Léviathan", link: '' },
    { id: 'm76', type: 'clef', emoji: '💍', gx: 387,  gy: 3097, name: 'Fabricant Secret des Slimes',     desc: "Permet la confection Secrète de l'Anneau Gluant",       link: '' },
    { id: 'm77', type: 'clef', emoji: '💍', gx: 1092, gy: 1193, name: "Fabricant Secret des Araignées",  desc: "Permet la confection Secrète du Collier d'Aragorn",     link: '' },
  ],
  2: [],
};
