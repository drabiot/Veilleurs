...
/* ── PALIER 1 ── */
  ...
  /* ══ Palier 1 ══ */
  {
		id:'tunique_tactique',   			name:"Tunique Tactique",           		set:'tactique',     rarity:'commun',    cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:3,  img:"../img/compendium/textures/armors/chestplate_tactique.png",  						stats:{sante:[21,25], defense:0.4}, classes:['assassin','archer'] },
  {
		id:'jambieres_tactique', 			name:"Jambières Tactique",         		set:'tactique',     rarity:'commun',    cat:'jambières',
		category:	'armure',
		palier:1, lvl:3,  img:"../img/compendium/textures/armors/leggings_tactique.png",    						stats:{sante:[17,21], defense:0.4}, classes:['assassin','archer'] },
  {
		id:'bottes_tactique',    			name:"Bottes Tactique",             	set:'tactique',     rarity:'commun',    cat:'bottes',
		category:	'armure',
		palier:1, lvl:3,  img:"../img/compendium/textures/armors/boots_tactique.png",        						stats:{sante:[15,18], defense:0.3}, classes:['assassin','archer'] },
  {
		id:'tunique_ninja',   				name:"Tunique du Ninja",            	set:'ninja',        rarity:'rare',      cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:7, 	img:"../img/compendium/textures/armors/chestplate_ninja.png",     						stats:{sante:[29,34], defense:[1.5,2.3]}, classes:['assassin'] },
  {
		id:'jambieres_ninja', 				name:"Jambières du Ninja",          	set:'ninja',        rarity:'rare',      cat:'jambières',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/leggings_ninja.png",       						stats:{sante:[23,27], defense:[0.9,1.4]}, classes:['assassin'] },
  {
		id:'bottes_ninja',    				name:"Bottines du Ninja",            	set:'ninja',        rarity:'rare',      cat:'bottes',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/boots_ninja.png",           						stats:{sante:[18,23], defense:[0.8,1]}, classes:['assassin'] },
  {
		id:'tunique_chasseur',   			name:"Plastron du Chasseur",         	set:'chasseur',     rarity:'rare',      cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:7, 	img:"../img/compendium/textures/armors/chestplate_chasseur.png",  						stats:{sante:[25,30], defense:[1.3,2]}, classes:['archer'] },
  {
		id:'jambieres_chasseur', 			name:"Jambières du Chasseur",        	set:'chasseur',     rarity:'rare',      cat:'jambières',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/leggings_chasseur.png",    						stats:{sante:[20,24], defense:[0.7,1.2]}, classes:['archer'] },
  {
		id:'bottes_chasseur',    			name:"Bottines du Chasseur",          	set:'chasseur',     rarity:'rare',      cat:'bottes',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/boots_chasseur.png",        						stats:{sante:[16,20], defense:[0.7,0.9]}, classes:['archer'] },
  {
		id:'casque_heraut',      			name:"Casque du Héraut",              	set:'heraut',       rarity:'epique',    cat:'casque',
		category:	'armure',
		palier:1, lvl:9, 	img:"../img/compendium/textures/armors/helmet_heraut.png", 								stats:{sante:[26,31], defense:[2.7,3.2]}, classes:['assassin','archer'] },
  {
		id:'plastron_heraut',    			name:"Plastron du Héraut",            	set:'heraut',       rarity:'epique',    cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:9, 	img:"../img/compendium/textures/armors/chestplate_heraut.png", 							stats:{sante:[32,37], defense:[3.5,4.3], 'Emplacement de Runes':2}, classes:['assassin','archer'] },
  {
		id:'jambieres_heraut',   			name:"Jambières du Héraut",           	set:'heraut',       rarity:'epique',    cat:'jambières',
		category:	'armure',
		palier:1, lvl:9, 	img:"../img/compendium/textures/armors/leggings_heraut.png", 							stats:{sante:[23,27], defense:[2.9,3.4]}, classes:['assassin','archer'] },
  {
		id:'bottes_heraut',      			name:"Bottes du Héraut",               	set:'heraut',       rarity:'epique',    cat:'bottes',
		category:	'armure',
		palier:1, lvl:9, 	img:"../img/compendium/textures/armors/boots_heraut.png", 								stats:{sante:[18,23], defense:[2.8,3]}, classes:['assassin','archer'] },
  /* ══ Palier 2 ══ */
  {
		id:'casque_assassin',     			name:"Casque de l'assassin",         	set:'abeille_assa', rarity:'rare',    	cat:'casque',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/helmet_abeille.png", 							stats:{sante:[26,31], defense:[3.3,3.6]}, classes:['assassin'] },
  {
		id:'plastron_assassin',   			name:"Plastron de l'assassin",       	set:'abeille_assa', rarity:'rare',    	cat:'plastron',
		category:	'armure',
		palier:2,
		lvl:11, 	img:"../img/compendium/textures/armors/chestplate_abeille.png", 						stats:{sante:[37,42], defense:[4.3,4.7], 'Emplacement de Runes':1}, classes:['assassin'] },
  {
		id:'jambieres_assassin',   			name:"Jambières de l'assassin",      	set:'abeille_assa', rarity:'rare',    	cat:'jambières',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/leggings_abeille.png", 							stats:{sante:[27,31.06], defense:[3.4,3.7]}, classes:['assassin'] },
  {
		id:'bottes_assassin',     			name:"Bottes de l'assassin",          	set:'abeille_assa', rarity:'rare',    	cat:'bottes',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/boots_abeille.png", 								stats:{sante:[23.01,38.99], defense:[3,3.4]}, classes:['assassin'] },
  {
		id:'casque_necro_assa',     		name:"Casque du Nécromancien",         	set:'necro_assa', 	rarity:'epique',    cat:'casque',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/helmet_necromancien.png", 							stats:{sante:[32,37], defense:[3.7,4]}, classes:['assassin'] },
  {
		id:'plastron_necro_assa',   		name:"Plastron du Nécromancien",       	set:'necro_assa', 	rarity:'epique',    cat:'plastron',
		category:	'armure',
		palier:2,
		lvl:13, 	img:"../img/compendium/textures/armors/chestplate_necromancien.png", 						stats:{sante:[35,41.15], defense:[4.27,4.5], 'Emplacement de Runes':2}, classes:['assassin'] },
  {
		id:'jambieres_necro_assa',   		name:"Jambières du Nécromancien",      	set:'necro_assa', 	rarity:'epique',    cat:'jambières',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/leggings_necromancien.png", 							stats:{sante:[33,37.2], defense:[3.8,4.2]}, classes:['assassin'] },
  {
		id:'bottes_necro_assa',     		name:"Bottes du Nécromancien",          set:'necro_assa', 	rarity:'epique',    cat:'bottes',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/boots_necromancien.png", 								stats:{sante:[30,35.42], defense:3.5}, classes:['assassin'] },
  {
		id:'casque_chasseuse',     			name:"Casque de la chasseuse",         	set:'abeille_arch', rarity:'rare',    	cat:'casque',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/helmet_abeille.png", 							stats:{sante:[26,31], defense:[3.2,3.5]}, classes:['archer'] },
  {
		id:'plastron_chasseuse',   			name:"Plastron de la chasseuse",       	set:'abeille_arch', rarity:'rare',    	cat:'plastron',
		category:	'armure',
		palier:2,
		lvl:11, 	img:"../img/compendium/textures/armors/chestplate_abeille.png", 						stats:{sante:[35,40], defense:[4.1,4.5], 'Emplacement de Runes':1}, classes:['archer'] },
  {
		id:'jambieres_chasseuse',   		name:"Jambières de la chasseuse",      	set:'abeille_arch', rarity:'rare',    	cat:'jambières',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/leggings_abeille.png", 							stats:{sante:[26.01,29.99], defense:[3.2,3.5]}, classes:['archer'] },
  {
		id:'bottes_chasseuse',     			name:"Bottes de la chasseuse",          set:'abeille_arch', rarity:'rare',    	cat:'bottes',
		category:	'armure',
		palier:2, lvl:11, 	img:"../img/compendium/textures/armors/boots_abeille.png", 								stats:{sante:[21,27], defense:[2.8,3.2]}, classes:['archer'] },
  {
		id:'casque_necro_arch',     		name:"Casque du Nécromancien",         	set:'necro_arch', 	rarity:'epique',    cat:'casque',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/helmet_necromancien.png", 							stats:{sante:[29,32], defense:[3.13,3.37]}, classes:['archer'] },
  {
		id:'plastron_necro_arch',   		name:"Plastron du Nécromancien",       	set:'necro_arch', 	rarity:'epique',    cat:'plastron',
		category:	'armure',
		palier:2,
		lvl:13, 	img:"../img/compendium/textures/armors/chestplate_necromancien.png", 						stats:{sante:[41,44], defense:[4.6,5.06], 'Emplacement de Runes':2}, classes:['archer'] },
  {
		id:'jambieres_necro_arch',   		name:"Jambières du Nécromancien",      	set:'necro_arch', 	rarity:'epique',    cat:'jambières',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/leggings_necromancien.png", 							stats:{sante:[31,34], defense:[3.6,3.9]}, classes:['archer'] },
  {
		id:'bottes_necro_arch',     		name:"Bottes du Nécromancien",          set:'necro_arch', 	rarity:'epique',    cat:'bottes',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/boots_necromancien.png", 								stats:{sante:[28,31], defense:[3.3,3.6]}, classes:['archer'] },
  /* ══ Mage - Shaman ══ */
  /* ══ Palier 1 ══ */
  {
  ...
  {
		id:'jambieres_spectral', 			name:"Jambières Spectral",             	set:'spectral',     rarity:'commun',    cat:'jambières',
		category:	'armure',
		palier:1, lvl:3, 	img:"../img/compendium/textures/armors/leggings_spectral.png", 							stats:{sante:[13,17], defense:0.4}, classes:['mage','shaman'] },
  {
		id:'bottes_spectral',    			name:"Bottes Spectral",                 set:'spectral',     rarity:'commun',    cat:'bottes',
		category:	'armure',
		palier:1, lvl:3, 	img:"../img/compendium/textures/armors/boots_spectral.png", 							stats:{sante:[10,13], defense:0.3}, classes:['mage','shaman'] },
  {
		id:'robe_sorcier',       			name:"Robe du Sorcier",                 set:'sorcier',      rarity:'rare',      cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:7, 	img:"../img/compendium/textures/armors/chestplate_sorcier.png", 						stats:{sante:[27,32], defense:[1.5,2.3]}, classes:['mage'] },
  {
		id:'pantalon_sorcier',   			name:"Pantalon du Sorcier",             set:'sorcier',      rarity:'rare',      cat:'jambières',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/leggings_sorcier.png", 							stats:{sante:[20,24], defense:[0.9,1.4]}, classes:['mage'] },
  {
		id:'sandales_sorcier',   			name:"Sandales du Sorcier",             set:'sorcier',      rarity:'rare',      cat:'bottes',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/boots_sorcier.png", 								stats:{sante:[14,18.72], defense:[0.7,0.9]}, classes:['mage'] },
  {
		id:'robe_magicien',      			name:"Robe du Magicien",                set:'magicien',     rarity:'rare',      cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:7, 	img:"../img/compendium/textures/armors/chestplate_magicien.png", 						stats:{sante:[27,32], defense:[1.5,2.3]}, classes:['shaman'] },
  {
		id:'pantalon_magicien',  			name:"Pantalon du Magicien",            set:'magicien',     rarity:'rare',      cat:'jambières',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/leggings_magicien.png",   						stats:{sante:[20,24], defense:[0.9,1.4]}, classes:['shaman'] },
  {
		id:'sandales_magicien',  			name:"Sandales du Magicien",            set:'magicien',     rarity:'rare',      cat:'bottes',
		category:	'armure',
		palier:1, lvl:7, 	img:"../img/compendium/textures/armors/boots_magicien.png",       						stats:{sante:[14,18.72], defense:[0.7,0.9]}, classes:['shaman'] },
  {
		id:'casque_faucheuse',      		name:"Casque de la Faucheuse",          set:'faucheuse',    rarity:'epique',    cat:'casque',
		category:	'armure',
		palier:1, lvl:9, 	img:"../img/compendium/textures/armors/helmet_faucheuse.png", 							stats:{sante:[16,20], defense:[2.8,3.4]}, classes:['mage','shaman'] },
  {
		id:'plastron_faucheuse',    		name:"Plastron de la Faucheuse",        set:'faucheuse',    rarity:'epique',    cat:'plastron',
		category:	'armure',
		palier:1,
		lvl:9, 	img:"../img/compendium/textures/armors/chestplate_faucheuse.png", 						stats:{sante:[27,32], defense:[3.5,4.3], 'Emplacement de Runes':2}, classes:['mage','shaman'] },
  {
		id:'jambieres_faucheuse',   		name:"Jambières de la Faucheuse",       set:'faucheuse',    rarity:'epique',    cat:'jambières',
		category:	'armure',
		palier:1, lvl:9, 	img:"../img/compendium/textures/armors/leggings_faucheuse.png", 						stats:{sante:[20,24], defense:[2.9,3.4]}, classes:['mage','shaman'] },
  {
		id:'bottes_faucheuse',      		name:"Bottes de la Faucheuse",          set:'faucheuse',    rarity:'epique',    cat:'bottes',
		category:	'armure',
  ...
  {
		id:'casque_necro_mage',     		name:"Casque du Nécromancien",         	set:'necro_mage', 	rarity:'epique',    cat:'casque',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/helmet_necromancien.png", 							stats:{sante:[29,32], defense:[3.13,3.37]}, classes:['mage'] },
  {
		id:'plastron_necro_mage',   		name:"Plastron du Nécromancien",       	set:'necro_mage', 	rarity:'epique',    cat:'plastron',
		category:	'armure',
		palier:2,
		lvl:13, 	img:"../img/compendium/textures/armors/chestplate_necromancien.png", 						stats:{sante:[41,44], defense:[4.6,5.06], 'Emplacement de Runes':2}, classes:['mage'] },
  {
		id:'jambieres_necro_mage',   		name:"Jambières du Nécromancien",      	set:'necro_mage', 	rarity:'epique',    cat:'jambières',
		category:	'armure',
		palier:2, lvl:13, 	img:"../img/compendium/textures/armors/leggings_necromancien.png", 							stats:{sante:[31,34], defense:[3.6,3.9]}, classes:['mage'] },
  {
		id:'bottes_necro_mage',     		name:"Bottes du Nécromancien",          set:'necro_mage', 	rarity:'epique',    cat:'bottes',
		category:	'armure',
