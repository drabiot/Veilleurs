...
/* ── PALIER 1 ── */
	/* ══ Armes ══ */
  {
		...
		tats:			{degats:7, vitesse_attaque:1.2},
  ...
  /* ══ Arcs ══ */
  {
		id:'arc_courbe',      				name:"Arc Courbé",                    	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/arc_courbe.png",                     	stats:{degats:3, vitesse_attaque:1}, classes:['archer'] },
  {
		id:'arc_sylvestre',        			name:"Arc Sylvestre",                 	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/arc_sylvestre.png",                  	stats:{degats:[4,6], vitesse_attaque:1}, classes:['archer'] },
  {
		id:'arc_chasse',      				name:"Arc de Chasse",                 	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/arc_de_chasse.png",                  	stats:{degats:[10,13], vitesse_attaque:1}, classes:['archer'] },
  {
		id:'arc_fallen',      				name:"Arc du Fallen",                 	rarity:'epique',    cat:'arme_p',category:	'arme',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/arc_du_fallen.png",                  	stats:{degats:[14,16], vitesse_attaque:[1,1.1]}, classes:['archer'] },
  {
		id:'arc_nodachi',     				name:"Arc Nodachi",            			rarity:'mythique',  cat:'arme_p',category:	'arme',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/arc_nodachi.png",             			stats:{degats:23.5, vitesse_attaque:1.3, crit_chance:10, crit_degats:5}, classes:['archer'] },
  {
		id:'arc_abeille_traqueuse',     	name:"Arc de l'Abeille Traqueuse",    	rarity:'rare',  	cat:'arme_p',category:	'arme',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/arc_abeille_traqueuse.png",             	stats:{degats:[17,19], vitesse_attaque:[1,1.2]}, classes:['archer'] },
  {
		id:'arc_necropole',     			name:"Arc de la Nécropole",    			rarity:'epique',  	cat:'arme_p',category:	'arme',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/arc_necropole.png",             			stats:{degats:[20,22], vitesse_attaque:[1,1.3]}, classes:['archer'] },
  /* ══ Arbalètes ══ */
  {
		id:'arbalete_bandit',        		name:"Arbalète de Bandit",            	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/arbalete_de_bandit.png",             	stats:{degats:12, vitesse_attaque:0.7}, classes:['archer'] },
  {
		id:'arbalete_chasse', 				name:"Arbalète de Chasse",            	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/arbalete_de_chasse.png",             	stats:{degats:[15,19], vitesse_attaque:0.7}, classes:['archer'] },
  {
		id:'arbalete_cendre', 				name:"Arbalète de Cendre",            	rarity:'legendaire',cat:'arme_p',category:	'arme',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/arbalete_de_cendre.png",             	stats:{degats:23.5, vitesse_attaque:0.7}, classes:['archer'] },
  {
		id:'arbalete_abeille_fer',    		name:"Arbalète de l'Abeille de fer",    rarity:'rare',  	cat:'arme_p',category:	'arme',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/arbalete_de_labeille_de_fer.png",        stats:{degats:[23.5,25.26], vitesse_attaque:[0.7,0.8]}, classes:['archer'] },
  {
		id:'arbalete_necropole',     		name:"Arbalète de la Nécropole",    	rarity:'epique',  	cat:'arme_p',category:	'arme',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/arbalete_necropole.png",             	stats:{degats:[27,29], vitesse_attaque:[0.7,0.8]}, classes:['archer'] },
  /* ══ Mage - Shaman ══ */
  /* ══ Bâtons ══ */
  {
		id:'baton_mediocre_mag',   			name:"Bâton Médiocre",                	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/baton_mediocre_mage.png",            	stats:{degats:6.5, vitesse_attaque:1}, classes:['mage'] },
  {
		id:'baton_mediocre_sha',  			name:"Bâton Médiocre",                	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/baton_mediocre_shaman.png",          	stats:{degats:6.2, vitesse_attaque:1, soin_bonus:1}, classes:['shaman'] },
  {
		id:'baton_sylvestre_mag',  			name:"Bâton Sylvestre",               	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/baton_sylvestre_mage.png",           	stats:{degats:[12,13], vitesse_attaque:1}, classes:['mage'] },
  {
		id:'baton_sylvestre_sha',  			name:"Bâton Sylvestre",               	rarity:'commun',    cat:'arme_p',category:	'arme',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/baton_sylvestre_shaman.png",         	stats:{degats:[8,10], vitesse_attaque:1, soin_bonus:[1,2]}, classes:['shaman'] },
  {
		id:'baton_squelette_mag',  			name:"Bâton de Squelette",            	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_squelettique.png",             	stats:{degats:15, vitesse_attaque:1}, classes:['mage'] },
  {
		id:'baton_squelette_sha',  			name:"Bâton de Squelette",            	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_squelettique.png",             	stats:{degats:12, vitesse_attaque:1, soin_bonus:2.5}, classes:['shaman'] },
  {
		id:'baton_squelette_maudit_mag',  	name:"Bâton Squelette Maudit",        	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_de_squelette_maudit_mage.png", 	stats:{degats:18, vitesse_attaque:1.1, degats_competence:2.5, sante:-10, mana:-5}, classes:['mage'] },
  {
		id:'baton_squelette_maudit_sha',  	name:"Bâton Squelette Maudit",        	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_de_squelette_maudit_shaman.png",	stats:{degats:14, vitesse_attaque:1.1, soin_bonus:3.5, regen_mana:0.2, sante:-20}, classes:['shaman'] },
  {
		id:'baton_magicien',  				name:"Bâton du Magicien",             	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana.png",                  	stats:{degats:[18,21], vitesse_attaque:1}, classes:['mage'] },
  {
		id:'baton_sorcier',   				name:"Bâton du Sorcier",              	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana.png",                  	stats:{degats:[16,18], vitesse_attaque:1, soin_bonus:[2.5,3.5]}, classes:['shaman'] },
  {
		id:'baton_magicien_puissant',		name:"Bâton du Magicien Puissant",    	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana_puissant.png",         	stats:{degats:[20,22], vitesse_attaque:1.1, degats_competence:3, sante:-15, mana:-10}, classes:['mage'] },
  {
		id:'baton_sorcier_puissant', 		name:"Bâton du Sorcier Puissant",     	rarity:'rare',      cat:'arme_p',category:	'arme',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana_puissant.png",         	stats:{degats:[18,20], vitesse_attaque:1.1, soin_bonus:[3.5,4.5], regen_mana:0.2, sante:-30}, classes:['shaman'] },
  {
		id:'baton_obscur_mag',  			name:"Bâton Obscur",                  	rarity:'epique',    cat:'arme_p',category:	'arme',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_mage.png",              	stats:{degats:[21.5,24.5], vitesse_attaque:1}, classes:['mage'] },
  {
		id:'baton_obscur_sha',  			name:"Bâton Obscur",                  	rarity:'epique',    cat:'arme_p',category:	'arme',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_shaman.png",            	stats:{degats:[19,22], vitesse_attaque:1, soin_bonus:[3,4]}, classes:['shaman'] },
  {
		id:'baton_obscur_puissant_mag',		name:"Bâton Obscur Puissant",         	rarity:'epique',    cat:'arme_p',category:	'arme',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_mage.png",              	stats:{degats:[23,27], vitesse_attaque:1.1, degats_competence:4, sante:-20, mana:-15}, classes:['mage'] },
  {
		id:'baton_obscur_puissant_sha',		name:"Bâton Obscur Puissant",         	rarity:'epique',    cat:'arme_p',category:	'arme',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_shaman.png",            	stats:{degats:[21,22], vitesse_attaque:1.1, soin_bonus:[4.5,5.5], regen_mana:0.3, sante:-40}, classes:['shaman'] },
  {
		id:'baton_nodachi_mag', 			name:"Bâton Nodachi",                 	rarity:'mythique',  cat:'arme_p',category:	'arme',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/baton_nodachi.png",                  	stats:{degats:50, vitesse_attaque:1, crit_comp_chance:15}, classes:['mage'] },
  {
		id:'baton_nodachi_sha', 			name:"Bâton Nodachi",                 	rarity:'mythique',  cat:'arme_p',category:	'arme',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/baton_nodachi.png",                  	stats:{degats:35, vitesse_attaque:1.2, soin_bonus:10, regen_sante:0.3, regen_mana:0.3}, classes:['shaman'] },
  {
		id:'spectre_hivernal_sha', 			name:"Scpetre Hivernale",               rarity:'',  		cat:'arme_p',category:	'arme',  palier:0, lvl:10, img:"../img/compendium/textures/weapons/events/staff_christmas.png",                  					stats:{degats:25, vitesse_attaque:1, soin_bonus:6}, classes:['shaman'] },
  /* ══ Catalyseurs ══ */
  {
