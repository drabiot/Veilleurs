...
const ITEMS = [
  /* ── PALIER 1 ── */
/* ══ Armes ══ */
  { id:'dague_entrainement',      		name:"Dague d'Entrainement",          	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/dague_dentrainement.png",            	stats:{degats:7, vitesse_attaque:1.2} },
  /* ══ Guerrier ══ */
  /* ══ Épées ══ */
  { id:'epee_entrainement',       		name:"Épée d'Entrainement",           	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/epee_dentrainement.png",             	stats:{degats:12, vitesse_attaque:1}, classes:['guerrier'] },
  { id:'epee_fer',        				name:"Épée en Fer",                   	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/epee_en_fer.png",                    	stats:{degats:[14,16], vitesse_attaque:1}, classes:['guerrier'] },
  { id:'epee_osseuse',        			name:"Épée Osseuse",                  	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/epee_osseuse.png",                   	stats:{degats:17.5, vitesse_attaque:1}, classes:['guerrier'] },
  { id:'epee_magique',        			name:"Épée Magique",                  	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/epee_magique.png",                   	stats:{degats:[18,20], vitesse_attaque:1.1}, classes:['guerrier'] },
  { id:'epee_gardien',       			name:"Épée du Gardien",               	rarity:'rare',      cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/epee_du_gardien.png",                	stats:{degats:[20,24], vitesse_attaque:1.1, crit_chance:[8,12]}, classes:['guerrier'] },
  { id:'nodachi',         				name:"Nodachi",                       	rarity:'mythique',  cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/nodachi.png",                        	stats:{degats:45, vitesse_attaque:1.2, crit_chance:10, crit_degats:10}, classes:['guerrier'] },
  { id:'epee_dard_tranchant',         	name:"Épée du Dard Tranchant",         	rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/epee_dard_tranchant.png",                stats:{degats:[26.01,29.99], vitesse_attaque:1.2}, classes:['guerrier'] },
  { id:'epee_necromancien',         	name:"Épée du Nécromancien",         	rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/epee_necromancien.png",                	stats:{degats:[30,35], vitesse_attaque:1.2, crit_chance:[10,15]}, classes:['guerrier'] },
  /* ══ Boucliers ══ */
  { id:'bouclier_pacotille',      		name:"Bouclier de Pacotille",         	rarity:'commun',    cat:'arme_s',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/bouclier_de_pacotille.png",          	stats:{sante:5}, classes:['guerrier'] },
  { id:'bouclier_ika',       			name:"Bouclier d'Ika",                	rarity:'commun',    cat:'arme_s',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/bouclier_dika.png",                  	stats:{sante:[8,12], defense:[1,1.5]}, classes:['guerrier'] },
  { id:'bouclier_pointu_bois',      	name:"Bouclier Pointu Bois",          	rarity:'commun',    cat:'arme_s',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/bouclier_pointu_en_bois.png",        	stats:{sante:[4,6], defense:[0.5,0.8], degats:0.5}, classes:['guerrier'] },
  { id:'bouclier_sylestre',       		name:"Bouclier Sylvestre",            	rarity:'rare',      cat:'arme_s',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/bouclier_sylvestre.png",             	stats:{sante:15, defense:1.7}, classes:['guerrier'] },
  { id:'bouclier_resistant_tolbana',    name:"Bouclier Résistant de Tolbana", 	rarity:'rare',      cat:'arme_s',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/bouclier_resistant_de_tolbana.png",  	stats:{sante:[16,20], defense:[1.9,2.1]}, classes:['guerrier'] },
  { id:'bouclier_puissant_tolbana',     name:"Bouclier Puissant de Tolbana",  	rarity:'rare',      cat:'arme_s',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/bouclier_puissant_de_tolbana.png",   	stats:{sante:[8,12], defense:[1.2,1.4], degats:2}, classes:['guerrier'] },
  { id:'bouclier_illfang',       		name:"Bouclier de Illfang",           	rarity:'mythique',  cat:'arme_s',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/bouclier_de_illfang.png",            	stats:{sante:45, defense:5}, classes:['guerrier'] },
  { id:'bouclier_maudit',       		name:"Bouclier Maudit",           		rarity:'epique', 	cat:'arme_s',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/bouclier_maudit.png",            		stats:{sante:[25.71,34.29], defense:[3,4]}, classes:['guerrier'] },
  /* ══ Hast ══ */
  { id:'hache_double_fer',       		name:"Hache Double en Fer",           	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/hache_double_en_fer.png",            	stats:{degats:[17,19], vitesse_attaque:0.9}, classes:['guerrier'] },
  { id:'marteau_colosse',     			name:"Marteau du Colosse",            	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/marteau_du_colosse.png",             	stats:{degats:23, vitesse_attaque:0.8}, classes:['guerrier'] },
  { id:'marteau_magique',     			name:"Marteau Magique",               	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/marteau_magique.png",                	stats:{degats:[25,30], vitesse_attaque:0.8}, classes:['guerrier'] },
  { id:'hallebarde_royale',  			name:"Hallebarde Royale",             	rarity:'legendaire',cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/hallebarde_royale.png",              	stats:{degats:35, vitesse_attaque:0.7}, classes:['guerrier'] },
  { id:'hache_illfang',       			name:"Hache de Illfang",              	rarity:'legendaire',cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/hache_de_illfang.png",               	stats:{degats:60, vitesse_attaque:0.7}, classes:['guerrier'] },
  { id:'marteau_dard_ecrasant',         name:"Marteau du Dard Écrasant",        rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/marteau_dard_ecrasant.png",              stats:{degats:[35,40], vitesse_attaque:0.8}, classes:['guerrier'] },
  { id:'marteau_necromancien',         	name:"Marteau du Nécromancien",         rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/marteau_necromancien.png",               stats:{degats:[45,50], vitesse_attaque:0.8}, classes:['guerrier'] },
  /* ══ Assassin ══ */
  { id:'dague_delabree',      			name:"Dague Délabrée",                	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/dague_delabree.png",                 	stats:{degats:13.5, vitesse_attaque:1.1}, classes:['assassin'] },
  { id:'dague_intermedaire',       		name:"Dague Intermédiaire",           	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/dague_intermediaire.png",            	stats:{degats:[17,20], vitesse_attaque:[1.1,1.2]}, classes:['assassin'] },
  { id:'dague_bandit',      			name:"Dague de Bandit",               	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/dague_de_bandit.png",                	stats:{degats:25, vitesse_attaque:1.2}, classes:['assassin'] },
  { id:'dague_sombre',    				name:"Dague Sombre",                  	rarity:'epique',    cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/dague_sombre.png",                   	stats:{degats:[27,31], vitesse_attaque:1.2}, classes:['assassin'] },
  { id:'longue_dague_sombre',  			name:"Longue Dague Sombre",           	rarity:'epique',    cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/longue_dague_sombre.png",            	stats:{degats:[35,40], vitesse_attaque:[0.8,0.9]}, classes:['assassin'] },
  { id:'dague_heroique',      			name:"Dague Héroïque",                	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/dague_heroique.png",                 	stats:{degats:[31,35], vitesse_attaque:[1.3,1.5]}, classes:['assassin'] },
  { id:'katana_heroique',     			name:"Katana Héroïque",               	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/katana_heroique.png",                	stats:{degats:[40,44.98], vitesse_attaque:[0.7,0.9]}, classes:['assassin'] },
  { id:'dague_nodachi',   				name:"Dague Nodachi",            		rarity:'mythique',  cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/dague_nodachi.png",             			stats:{degats:55, vitesse_attaque:1.8, vol_vie:3.5, vitesse_deplacement:1}, classes:['assassin'] },
  { id:'serpe_assassine',   			name:"Serpe Assassine",            		rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/serpe_assassine.png",             		stats:{degats:[34,38], vitesse_attaque:[1.4,1.5]}, classes:['assassin'] },
  { id:'faux_assassine',  	 			name:"Faux Assassine",            		rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/faux_assassine.png",             		stats:{degats:[46,50], vitesse_attaque:0.8}, classes:['assassin'] },
  { id:'serpe_necromancienne',   		name:"Serpe Nécromancienne",            rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/serpe_necromancienne.png",             	stats:{degats:[39,43.99], vitesse_attaque:[1.4,1.5]}, classes:['assassin'] },
  { id:'faux_necromancienne',  	 		name:"Faux Nécromancienne",            	rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/faux_necromancienne.png",             	stats:{degats:[51,57], vitesse_attaque:0.8}, classes:['assassin'] },
  /* ══ Archer ══ */
  /* ══ Archer ══ */
  /* ══ Arcs ══ */
  { id:'arc_courbe',      				name:"Arc Courbé",                    	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/arc_courbe.png",                     	stats:{degats:3, vitesse_attaque:1}, classes:['archer'] },
  { id:'arc_sylvestre',        			name:"Arc Sylvestre",                 	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/arc_sylvestre.png",                  	stats:{degats:[4,6], vitesse_attaque:1}, classes:['archer'] },
  { id:'arc_chasse',      				name:"Arc de Chasse",                 	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/arc_de_chasse.png",                  	stats:{degats:[10,13], vitesse_attaque:1}, classes:['archer'] },
  { id:'arc_fallen',      				name:"Arc du Fallen",                 	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/arc_du_fallen.png",                  	stats:{degats:[14,16], vitesse_attaque:[1,1.1]}, classes:['archer'] },
  { id:'arc_nodachi',     				name:"Arc Nodachi",            			rarity:'mythique',  cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/arc_nodachi.png",             			stats:{degats:23.5, vitesse_attaque:1.3, crit_chance:10, crit_degats:5}, classes:['archer'] },
  { id:'arc_abeille_traqueuse',     	name:"Arc de l'Abeille Traqueuse",    	rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/arc_abeille_traqueuse.png",             	stats:{degats:[17,19], vitesse_attaque:[1,1.2]}, classes:['archer'] },
  { id:'arc_necropole',     			name:"Arc de la Nécropole",    			rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/arc_necropole.png",             			stats:{degats:[20,22], vitesse_attaque:[1,1.3]}, classes:['archer'] },
  /* ══ Arbalètes ══ */
  { id:'arbalete_bandit',        		name:"Arbalète de Bandit",            	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/arbalete_de_bandit.png",             	stats:{degats:12, vitesse_attaque:0.7}, classes:['archer'] },
  { id:'arbalete_chasse', 				name:"Arbalète de Chasse",            	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/arbalete_de_chasse.png",             	stats:{degats:[15,19], vitesse_attaque:0.7}, classes:['archer'] },
  { id:'arbalete_cendre', 				name:"Arbalète de Cendre",            	rarity:'legendaire',cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/arbalete_de_cendre.png",             	stats:{degats:23.5, vitesse_attaque:0.7}, classes:['archer'] },
  { id:'arbalete_abeille_fer',    		name:"Arbalète de l'Abeille de fer",    rarity:'rare',  	cat:'arme_p',  palier:2, lvl:11, img:"../img/compendium/textures/weapons/arbalete_de_labeille_de_fer.png",        stats:{degats:[23.5,25.26], vitesse_attaque:[0.7,0.8]}, classes:['archer'] },
  { id:'arbalete_necropole',     		name:"Arbalète de la Nécropole",    	rarity:'epique',  	cat:'arme_p',  palier:2, lvl:13, img:"../img/compendium/textures/weapons/arbalete_necropole.png",             	stats:{degats:[27,29], vitesse_attaque:[0.7,0.8]}, classes:['archer'] },
  /* ══ Mage - Shaman ══ */
  /* ══ Bâtons ══ */
  { id:'baton_mediocre_mag',   			name:"Bâton Médiocre",                	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/baton_mediocre_mage.png",            	stats:{degats:6.5, vitesse_attaque:1}, classes:['mage'] },
  { id:'baton_mediocre_sha',  			name:"Bâton Médiocre",                	rarity:'commun',    cat:'arme_p',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/baton_mediocre_shaman.png",          	stats:{degats:6.2, vitesse_attaque:1, soin_bonus:1}, classes:['shaman'] },
  { id:'baton_sylvestre_mag',  			name:"Bâton Sylvestre",               	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/baton_sylvestre_mage.png",           	stats:{degats:[12,13], vitesse_attaque:1}, classes:['mage'] },
  { id:'baton_sylvestre_sha',  			name:"Bâton Sylvestre",               	rarity:'commun',    cat:'arme_p',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/baton_sylvestre_shaman.png",         	stats:{degats:[8,10], vitesse_attaque:1, soin_bonus:[1,2]}, classes:['shaman'] },
  { id:'baton_squelette_mag',  			name:"Bâton de Squelette",            	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_squelettique.png",             	stats:{degats:15, vitesse_attaque:1}, classes:['mage'] },
  { id:'baton_squelette_sha',  			name:"Bâton de Squelette",            	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_squelettique.png",             	stats:{degats:12, vitesse_attaque:1, soin_bonus:2.5}, classes:['shaman'] },
  { id:'baton_squelette_maudit_mag',  	name:"Bâton Squelette Maudit",        	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_de_squelette_maudit_mage.png", 	stats:{degats:18, vitesse_attaque:1.1, degats_competence:2.5, sante:-10, mana:-5}, classes:['mage'] },
  { id:'baton_squelette_maudit_sha',  	name:"Bâton Squelette Maudit",        	rarity:'rare',      cat:'arme_p',  palier:1, lvl:5,  img:"../img/compendium/textures/weapons/baton_de_squelette_maudit_shaman.png",	stats:{degats:14, vitesse_attaque:1.1, soin_bonus:3.5, regen_mana:0.2, sante:-20}, classes:['shaman'] },
  { id:'baton_magicien',  				name:"Bâton du Magicien",             	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana.png",                  	stats:{degats:[18,21], vitesse_attaque:1}, classes:['mage'] },
  { id:'baton_sorcier',   				name:"Bâton du Sorcier",              	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana.png",                  	stats:{degats:[16,18], vitesse_attaque:1, soin_bonus:[2.5,3.5]}, classes:['shaman'] },
  { id:'baton_magicien_puissant',		name:"Bâton du Magicien Puissant",    	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana_puissant.png",         	stats:{degats:[20,22], vitesse_attaque:1.1, degats_competence:3, sante:-15, mana:-10}, classes:['mage'] },
  { id:'baton_sorcier_puissant', 		name:"Bâton du Sorcier Puissant",     	rarity:'rare',      cat:'arme_p',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/baton_tolbana_puissant.png",         	stats:{degats:[18,20], vitesse_attaque:1.1, soin_bonus:[3.5,4.5], regen_mana:0.2, sante:-30}, classes:['shaman'] },
  { id:'baton_obscur_mag',  			name:"Bâton Obscur",                  	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_mage.png",              	stats:{degats:[21.5,24.5], vitesse_attaque:1}, classes:['mage'] },
  { id:'baton_obscur_sha',  			name:"Bâton Obscur",                  	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_shaman.png",            	stats:{degats:[19,22], vitesse_attaque:1, soin_bonus:[3,4]}, classes:['shaman'] },
  { id:'baton_obscur_puissant_mag',		name:"Bâton Obscur Puissant",         	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_mage.png",              	stats:{degats:[23,27], vitesse_attaque:1.1, degats_competence:4, sante:-20, mana:-15}, classes:['mage'] },
  { id:'baton_obscur_puissant_sha',		name:"Bâton Obscur Puissant",         	rarity:'epique',    cat:'arme_p',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/baton_obscur_shaman.png",            	stats:{degats:[21,22], vitesse_attaque:1.1, soin_bonus:[4.5,5.5], regen_mana:0.3, sante:-40}, classes:['shaman'] },
  { id:'baton_nodachi_mag', 			name:"Bâton Nodachi",                 	rarity:'mythique',  cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/baton_nodachi.png",                  	stats:{degats:50, vitesse_attaque:1, crit_comp_chance:15}, classes:['mage'] },
  { id:'baton_nodachi_sha', 			name:"Bâton Nodachi",                 	rarity:'mythique',  cat:'arme_p',  palier:1, lvl:10, img:"../img/compendium/textures/weapons/baton_nodachi.png",                  	stats:{degats:35, vitesse_attaque:1.2, soin_bonus:10, regen_sante:0.3, regen_mana:0.3}, classes:['shaman'] },
  { id:'spectre_hivernal_sha', 			name:"Scpetre Hivernale",               rarity:'',  		cat:'arme_p',  palier:0, lvl:10, img:"../img/compendium/textures/weapons/events/staff_christmas.png",                  					stats:{degats:25, vitesse_attaque:1, soin_bonus:6}, classes:['shaman'] },
  /* ══ Catalyseurs ══ */
  { id:'grimoire_delie',      			name:"Grimoire Delié",                	rarity:'commun',    cat:'arme_s',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/grimoire_delie-sauvage.png",         	stats:{degats_magique:2, mana:5}, classes:['mage'] },
  { id:'grimoire_sauvage',    			name:"Grimoire Sauvage",              	rarity:'commun',    cat:'arme_s',  palier:1, lvl:1,  img:"../img/compendium/textures/weapons/grimoire_delie-sauvage.png",         	stats:{regen_mana:0.1, mana:5}, classes:['shaman'] },
  { id:'grimoire_sylvestre',       		name:"Grimoire Sylvestre",            	rarity:'commun',    cat:'arme_s',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/grimoire_sylvestre.png",             	stats:{degats_magique:2.5, mana:7.5}, classes:['mage'] },
  { id:'grimoire_bestial',       		name:"Grimoire Bestial",              	rarity:'commun',    cat:'arme_s',  palier:1, lvl:3,  img:"../img/compendium/textures/weapons/grimoire_bestial.png",               	stats:{regen_mana:0.15, mana:7.5}, classes:['shaman'] },
  { id:'grimoire_magicien',        		name:"Grimoire du Magicien",          	rarity:'rare',      cat:'arme_s',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/grimoire_du_magicien.png",           	stats:{degats_magique:3.5, mana:10}, classes:['mage'] },
  { id:'grimoire_sorier',        		name:"Grimoire du Sorcier",           	rarity:'rare',      cat:'arme_s',  palier:1, lvl:7,  img:"../img/compendium/textures/weapons/grimoire_du_sorcier.png",            	stats:{regen_mana:0.25, mana:10}, classes:['shaman'] },
  { id:'grimoire_obsc',       			name:"Grimoire Obscur",               	rarity:'rare',      cat:'arme_s',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/grimoire_obscur.png",                	stats:{degats_magique:4, mana:12.5}, classes:['mage'] },
  { id:'grimoire_fant',       			name:"Grimoire Fantomatique",         	rarity:'rare',      cat:'arme_s',  palier:1, lvl:9,  img:"../img/compendium/textures/weapons/grimoire_fantome.png",               	stats:{regen_mana:0.3, mana:12.5}, classes:['shaman'] },
  
  /* ══ Accessoires ══ */
  /* ══ Anneaux ══ */
  /* ══ Palier 1 ══ */
  { id:'anneau_cuivre',   				name:"Anneau de Cuivre",				set:'cuivre',    	rarity:'commun',    cat:'anneau',    	palier:1, lvl:3,  img:"../img/compendium/textures/trinkets/P1/Set de Cuivre/Anneau de Cuivre.png",                         	stats:{sante:5} },
  { id:'anneau_pumba',    				name:"Anneau de Pumba",                        				rarity:'legendaire',cat:'anneau',    	palier:1, lvl:3, 	img:"../img/compendium/textures/trinkets/P1/Anneau de Pumba.png",                                        	stats:{sante:10, defense:1} },
  { id:'anneau_fer',      				name:"Anneau de Fer",					set:'fer',       	rarity:'rare',      cat:'anneau',    	palier:1, lvl:5,  img:"../img/compendium/textures/trinkets/P1/Set de Fer/Anneau de Fer.png",                               	stats:{defense:0.5} },
  { id:'bague_gluante',      			name:"Bague Gluante",       			set:'slime',     	rarity:'commun',    cat:'anneau',    	palier:1, lvl:5,  img:"../img/compendium/textures/trinkets/P1/Set des Slimes Gélatineux/Bague Gluante.png",               	stats:{sante:2.5, regen_sante:0.1} },
  { id:'bague_squelette',      			name:"Bague de Squelette",  			set:'squelette', 	rarity:'commun',    cat:'anneau',    	palier:1, lvl:7,  img:"../img/compendium/textures/trinkets/P1/Set Squelette Poussiéreux/Bague de Squelette.png",          	stats:{degats_competence:1, sante:2.5} },
  { id:'anneau_sylvestre',     			name:"Anneau Sylvestre",    			set:'sylve',     	rarity:'rare',      cat:'anneau',    	palier:1, lvl:7,  img:"../img/compendium/textures/trinkets/P1/Set de la Sylve/Anneau Sylvestre.png",                      	stats:{soin_bonus:1, mana:1, stamina:0.5, regen_sante:0.2} },
  { id:'anneau_gluant',     			name:"Anneau Gluant",       			set:'slime',     	rarity:'epique',    cat:'anneau',    	palier:1, lvl:9, 	img:"../img/compendium/textures/trinkets/P1/Set des Slimes Gélatineux/Anneau Gluant.png",               	stats:{tenacite:15, sante:20, regen_sante:0.5} },
  { id:'anneau_leviathan',     			name:"Anneau de Léviathan",                      			rarity:'epique',    cat:'anneau',    	palier:1, lvl:9, 	img:"../img/compendium/textures/trinkets/P1/Anneau de Léviathan.png",                                   	stats:{defense:2.5} },
  /* ══ Palier 2 ══ */
  { id:'bague_bouleau',     			name:"Bague de Bouleau",                      				rarity:'rare',    	cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Bague de Bouleau.png",                                   		stats:{defense:1, sante:10} },
  { id:'anneau_acacia',     			name:"Anneau d'Acacia",                      				rarity:'rare',    	cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Anneau d'Acacia.png",                                   		stats:{degats:2, crit_chance:2.5, sante:5} },
  { id:'anneau_mielleux',     			name:"Anneau Mielleux",                      				rarity:'commun',    cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Anneau Mielleux.png",                                   		stats:{soin_bonus:1, sante:10} },
  { id:'anneau_taureau',     			name:"Anneau du Taureau",              	set:'taureau',      rarity:'commun',    cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Set des Taureaux/Anneau du Taureau.png",                        stats:{degats:2, sante:10} },
  { id:'anneau_ours',     				name:"Anneau de l'Ours",              	set:'ours',        	rarity:'commun',    cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Set des Ours/Anneau de l'Ours.png",                             stats:{crit_comp_degats:1, defense:0.5, sante:5} },
  { id:'anneau_ferraille',     			name:"Anneau de Ferraille",             set:'ferraille',    rarity:'commun',    cat:'anneau',    	palier:2, lvl:11, img:"../img/compendium/textures/trinkets/P2/Set de Ferraille/Anneau de Ferraille.png",                      stats:{defense:0.5, sante:10} },
  { id:'anneau_bauxite',     			name:"Anneau de Bauxite",            	set:'bauxite',    	rarity:'rare',    	cat:'anneau',    	palier:2, lvl:12, img:"../img/compendium/textures/trinkets/P2/Set de Bauxite/Anneau de Bauxite.png",                      	stats:{defense:1, sante:10} },
  { id:'anneau_aventurier',     		name:"Anneau de l'Aventurier",           			    	rarity:'rare',    	cat:'anneau',    	palier:2, lvl:13, img:"",                      	stats:{vitesse_attaque:0.1, crit_comp_degats:1, defense:1, soin_bonus:1, sante:1, mana:1, stamina:1, regen_sante:0.1, regen_mana:0.1, regen_stamina:0.1} },
  { id:'anneau_harpie_enflammee',     	name:"Anneau de la Harpie Enflammée",  				    	rarity:'epique',    cat:'anneau',    	palier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Anneau de la Harpie Enflammée.png",                      		stats:{degat_arme:7.5, vol_vie:2, sante:15} },
  { id:'anneau_harpie_ecrasee',     	name:"Anneau de la Harpie Écrasée",  				    	rarity:'epique',    cat:'anneau',    	palier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Anneau de la Harpie Écrasée.png",                      			stats:{defense:2.5, reduction_degats:2.5, maitrise_bloc:5, puissance_bloc:1} },
  { id:'anneau_harpie_noyee',     		name:"Anneau de la Harpie Noyée",  				    		rarity:'epique',    cat:'anneau',    	palier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Anneau de la Harpie Noyée.png",                      			stats:{degats_competence:7.5, omnivamp:1.5, mana:10, stamina:5} },
  { id:'anneau_onyx_impur',     		name:"Anneau d'Onyx Impur",            	set:'onyx_impur',   rarity:'epique',   	cat:'anneau',    	palier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Anneau d'Onyx Impur.png",                     	stats:{crit_chance:1, defense:1.5, sante:10} },
  { id:'anneau_winnie',     			name:"Anneau de Winnie",           		set:'ours',   		rarity:'mythique',  cat:'anneau',    	palier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set des Ours/Bague de Winnie.png",                     			stats:{crit_chance:5, crit_comp_chance:5, reduction_degats:2.5, sante:10} },
  { id:'anneau_onyx_pur',     			name:"Anneau d'Onyx Pur",            	set:'onyx_pur',   	rarity:'legendaire',cat:'anneau',    	palier:2, lvl:14, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Anneau d'Onyx Pur.png",                     		stats:{crit_chance:2, crit_degats:1, defense:1, sante:20} },
  /* ══ Events ══ */
  { id:'anneau_amour',    				name:"Anneau d'Amour",          			    			rarity:'',   	 	cat:'anneau',     	palier:0, lvl:10, img:"../img/compendium/textures/trinkets/Valentin/Anneau d'Amour.png",                        				stats:{crit_chance:5, crit_degats:5, crit_comp_chance:5, crit_comp_degats:5, sante:15} },
  /* ══ Amulettes ══ */
  /* ══ Palier 1 ══ */
