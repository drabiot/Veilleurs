...
const FLOOR_MARKERS = {
  1: [
    ...
    { id: 'm1a1',  type: 'artisant', gx: 1772, gy: 4135, name: "Forgeron d'Armes",                  desc: "Forgeron des Armes pour Débutants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#arme' },
    { id: 'm1a2',  type: 'artisant', gx: 1760, gy: 4145, name: "Forgeron d'Armures",                desc: "Forgeron des Armures pour Débutants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#armure' },
    { id: 'm1a3',  type: 'artisant', gx: 1767, gy: 4126, name: "Forgeron d'Accessoires",            desc: "Forgeron des Accessoires pour Débutants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#accessoires-base' },
    { id: 'm1a4',  type: 'artisant', gx: 1789, gy: 4609, name: 'Marchand Étrange',                  desc: "Marchand suspect trainant derrière la Cathédrale", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#marchand-etrange' },
    { id: 'm1a5',  type: 'artisant', gx: 1787, gy: 4697, name: "Forgeron d'Accessoires en Cuivre",  desc: "Forgeron des Accessoires en Cuivre pour Débutants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#accessoires-cuivre' },
    { id: 'm1a6',  type: 'artisant', gx: 1776, gy: 4684, name: "Forgeron d'Accessoires en Fer",     desc: "Forgeron des Accessoires en Fer pour Débutants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#accessoires-fer' },
    { id: 'm1a7',  type: 'artisant', gx: 1776, gy: 4693, name: 'Refaçonneur',                       desc: "Permet la fabrication de ficelle en tout genre", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/refaconneurs#ville-de-depart' },
    { id: 'm1a8',  type: 'artisant', gx: 2397, gy: 3568, name: 'Forgeron de Lingots',               desc: "Forgeron de Lingots de Cuivre et de Fer", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#lingots' },
    { id: 'm1a9',  type: 'artisant', gx: 3235, gy: 1482, name: "Forgeron d'Armes",                  desc: "Forgeron des Armes pour Confirmés", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#arme-1' },
    { id: 'm1a10', type: 'artisant', gx: 3237, gy: 1477, name: "Forgeron d'Armures",                desc: "Forgeron des Armures pour Confirmés", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#armure-1' },
    { id: 'm1a11', type: 'artisant', gx: 2415, gy: 2373, name: "Forgeron d'Armes",                  desc: "Forgeron d'Armes du Donjon du Labyrinthe des Déchus", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#arme-2' },
    { id: 'm1a12', type: 'artisant', gx: 2415, gy: 2373, name: "Forgeron d'Armures",                desc: "Forgeron d'Armures du Donjon du Labyrinthe des Déchus", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/forgerons#armure-2' },
    { id: 'm1a13', type: 'artisant', gx: 2467, gy: 4289, name: 'Bucheron',                          desc: "Bucheron permettant la Réalisation de Planches", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/bucherons#ville-de-depart' },
    { id: 'm1a14', type: 'artisant', gx: 1771, gy: 4096, name: 'Alchimiste',                        desc: "Alchimiste permettant la Réalisation de Potions et Cristaux", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/alchimistes#ville-de-depart' },
    { id: 'm1a15', type: 'artisant', gx: 3335, gy: 1613, name: 'Alchimiste',                        desc: "Alchimiste permettant la Réalisation de Potions et Cristaux", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/alchimistes#tolbana' },

    { id: 'm1b1',  type: 'repreneur_butin', gx: 1788, gy: 4179, name: 'Repreneur des Débutants',       desc: "Achète des ressources digne d'un Débutant", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#ville-de-depart' },
    { id: 'm1b2',  type: 'repreneur_butin', gx: 1509, gy: 3415, name: 'Repreneur de la Forêt',         desc: "Achète des ressources de la Forêt", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#hanaka' },
    { id: 'm1b3',  type: 'repreneur_butin', gx: 3155, gy: 3690, name: 'Repreneur Champêtre',           desc: "Achète des ressources des Champs", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#mizunari' },
    { id: 'm1b4',  type: 'repreneur_butin', gx: 413,  gy: 3089, name: 'Repreneur des Maraicages',      desc: "Achète des ressources Gluantes", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#vallaht' },
    { id: 'm1b5',  type: 'repreneur_butin', gx: 1598, gy: 1947, name: 'Repreneur des Mers',            desc: "Achète des ressources Maritimes", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#virelune' },
    { id: 'm1b6',  type: 'repreneur_butin', gx: 2832, gy: 4709, name: 'Repreneur de Squelette',        desc: "Achète des ressources venant des Morts", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#chateau-abandonne' },
    { id: 'm1b7',  type: 'repreneur_butin', gx: 3295, gy: 1629, name: 'Repreneur Agguerie de Tolbana', desc: "Achète des ressources digne d'un Combattant Agguerie", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/repreneurs-de-butins#tolbana' },
	{ id: 'm1b8',  type: 'repreneur_butin', gx: 1488, gy: 3403, name: 'Repreneur d\'Armes', desc: "Achète des Armes de niveau 5", link: '' },

    { id: 'm1m1',  type: 'marchand', gx: 1788, gy: 4162, name: "Marchand d'Équipement",    desc: "Vends des Armes et objets pour les Nouveaux Arrivants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#ville-de-depart' },
    { id: 'm1m2',  type: 'marchand', gx: 1503, gy: 3391, name: "Marchand d'Équipement",    desc: "Vends des Armes et objets pour les Nouveaux Arrivants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#hanaka' },
    { id: 'm1m3',  type: 'marchand', gx: 485,  gy: 3058, name: "Marchand d'Accessoires",   desc: "Vends des Accessoires Gluants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#vallhat' },
    { id: 'm1m4',  type: 'marchand', gx: 3320, gy: 1605, name: "Marchand d'Accessoires",   desc: "Vends des Accessoires Résistants", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#tolbana-1' },
    { id: 'm1m5',  type: 'marchand', gx: 1813, gy: 4162, name: "Marchand d'Outils",        desc: "Vends des outils pour récolter des matières premières", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#ville-de-depart-1' },
    { id: 'm1m6',  type: 'marchand', gx: 1587, gy: 1985, name: "Marchand d'Outils",        desc: "Vends des outils pour récolter des matières premières", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#virelune' },
    { id: 'm1m7',  type: 'marchand', gx: 3335, gy: 1621,  name: "Marchand d'Outils",        desc: "Vends des outils pour récolter des matières premières", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#tolbana-3' },
    { id: 'm1m8',  type: 'marchand', gx: 3309, gy: 1642, name: "Marchand de Consommables", desc: "Vends des Utilitaires comme des Potions ou des Parchemins", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#tolbana-2' },
    { id: 'm1m9',  type: 'marchand', gx: 3316, gy: 1642, name: "Marchand d'Équipement",    desc: "Vends des Armes et objets", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#tolbana' },
    { id: 'm1m10', type: 'marchand', gx: 2002, gy: 822, name: "Marchand d'Outils",        desc: "Vends des outils pour récolter des matières premières", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#candelia' },
    { id: 'm1m10', type: 'marchand', gx: 3150, gy: 3702, name: "Marchand d'Outils",        desc: "Vends des outils pour récolter des matières premières", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/marchands#mizunari' },

    { id: 'm1c1', type: 'clef', emoji: '🗝️', gx: 1812, gy: 4180, name: 'Clef du Donjon Mine de Geldorak',      desc: "Clef permettant d'ouvrir la porte du Donjon des Mines de Geldorak",     link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#ville-de-depart' },
    { id: 'm1c2', type: 'clef', emoji: '🗝️', gx: 4287, gy: 3893, name: 'Clef du Donjon Mine de Geldorak',      desc: "Clef permettant d'ouvrir la porte du Donjon des Mines de Geldorak",     link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#mine-de-geldorak' },
    { id: 'm1c3', type: 'clef', emoji: '🗝️', gx: 2388, gy: 2421, name: 'Clef du Donjon Labyrinthe des Déchus', desc: "Clef permettant d'ouvrir la porte du Donjon du Labyrinthe des Déchus", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#labyrinthe-des-dechus' },
    { id: 'm1c4', type: 'clef', emoji: '🗝️', gx: 1014,  gy: 1189, name: "Clef du Donjon Xal'Zirith",            desc: "Clef permettant d'ouvrir la porte du Donjon Xal'Zirith",                link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#xalzirith' },
    { id: 'm1c5', type: 'clef', emoji: '🗝️', gx: 1996, gy: 817,  name: "Clef du Donjon Xal'Zirith",            desc: "Clef permettant d'ouvrir la porte du Donjon Xal'Zirith",                link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#candelia' },
    { id: 'm1c6', type: 'clef', emoji: '💍', gx: 4216, gy: 1801, name: "Fabricant Secret de l'Ours",           desc: "Permet la confection Secrète du Bracelet de Glace",     link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#citadelle-des-neiges' },
    { id: 'm1c7', type: 'clef', emoji: '💍', gx: 1326, gy: 2107, name: 'Fabricant Secret du Léviathan',        desc: "Permet la confection Secrète de l'Anneau du Léviathan", link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#antre-de-aepep' },
    { id: 'm1c8', type: 'clef', emoji: '💍', gx: 391,  gy: 3065, name: 'Fabricant Secret des Slimes',          desc: "Permet la confection Secrète de l'Anneau Gluant",       link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#vallhat' },
    { id: 'm1c9', type: 'clef', emoji: '💍', gx: 1114, gy: 1172, name: "Fabricant Secret des Araignées",       desc: "Permet la confection Secrète du Collier d'Aragorn",     link: 'https://guilde-sao.gitbook.io/watchers/paliers/carte/personnages/fabricants-clefs-et-secret#arakhnol' },
