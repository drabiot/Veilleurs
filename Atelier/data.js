...
const ITEMS = [
  ...
  { id:'eppe_dard_tranchant',         	name:"Épée du Dard Tranchant",          rarity:'rare',  	cat:'arme_p',  tier:2, lvl:11, img:"",                        	stats:{degats:[26.01,29.99], vitesse_attaque:1.2}, classes:['guerrier'] },
  /* ══ Boucliers ══ */
  ...
  /* ══ Palier 2 ══ */
  { id:'casque_ruche',     				name:"Casque de la Ruche",         		set:'abeille_guer', rarity:'rare',    	cat:'casque',    	tier:2, lvl:11, 	img:"", 							stats:{sante:[35,41], defense:[3,3.5]}, classes:['guerrier'] },
  { id:'plastron_ruche',   				name:"Plastron de la Ruche",       		set:'abeille_guer', rarity:'rare',    	cat:'plastron',  	tier:2, lvl:11, 	img:"", 						stats:{sante:[40.01,49.99], defense:[4,5], 'Emplacement de Runes':1}, classes:['guerrier'] },
  { id:'jambieres_ruche',   			name:"Jambières de la Ruche",      		set:'abeille_guer', rarity:'rare',    	cat:'jambières', 	tier:2, lvl:11, 	img:"", 							stats:{sante:[37,45], defense:[3.5,3.9]}, classes:['guerrier'] },
  { id:'bottes_ruche',     				name:"Bottes de la Ruche",          	set:'abeille_guer', rarity:'rare',    	cat:'bottes',    	tier:2, lvl:11, 	img:"", 								stats:{sante:[33,38.99], defense:[2,2.5]}, classes:['guerrier'] },
  { id:'casque_necro_guer',     		name:"Casque du Nécromancien",         	set:'necro_guer', 	rarity:'epique',    cat:'casque',    	tier:2, lvl:13, 	img:"", 							stats:{sante:[43,50], defense:[4,4.5]}, classes:['guerrier'] },
  { id:'plastron_necro_guer',   		name:"Plastron du Nécromancien",       	set:'necro_guer', 	rarity:'epique',    cat:'plastron',  	tier:2, lvl:13, 	img:"", 						stats:{sante:[47,57], defense:[6,7], 'Emplacement de Runes':2}, classes:['guerrier'] },
  { id:'jambieres_necro_guer',   		name:"Jambières du Nécromancien",      	set:'necro_guer', 	rarity:'epique',    cat:'jambières', 	tier:2, lvl:13, 	img:"", 							stats:{sante:[45,51.98], defense:[4.5,5]}, classes:['guerrier'] },
  { id:'bottes_necro_guer',     		name:"Bottes du Nécromancien",          set:'necro_guer', 	rarity:'epique',    cat:'bottes',    	tier:2, lvl:13, 	img:"", 								stats:{sante:[41.01,46.99], defense:[3,3.5]}, classes:['guerrier'] },
  /* ══ Assassin - Archer ══ */
  /* ══ Palier 1 ══ */
  ...
  /* ══ Palier 2 ══ */
  { id:'casque_assassin',     			name:"Casque de l'assassin",         	set:'abeille_assa', rarity:'rare',    	cat:'casque',    	tier:2, lvl:11, 	img:"", 							stats:{sante:[26,31], defense:[3.3,3.6]}, classes:['assassin'] },
  { id:'plastron_assassin',   			name:"Plastron de l'assassin",       	set:'abeille_assa', rarity:'rare',    	cat:'plastron',  	tier:2, lvl:11, 	img:"", 						stats:{sante:[37,42], defense:[4.3,4.7], 'Emplacement de Runes':1}, classes:['assassin'] },
  { id:'jambieres_assassin',   			name:"Jambières de l'assassin",      	set:'abeille_assa', rarity:'rare',    	cat:'jambières', 	tier:2, lvl:11, 	img:"", 							stats:{sante:[27,31.06], defense:[3.4,3.7]}, classes:['assassin'] },
  { id:'bottes_assassin',     			name:"Bottes de l'assassin",          	set:'abeille_assa', rarity:'rare',    	cat:'bottes',    	tier:2, lvl:11, 	img:"", 								stats:{sante:[23.01,38.99], defense:[3,3.4]}, classes:['assassin'] },
  { id:'casque_necro_assa',     		name:"Casque du Nécromancien",         	set:'necro_assa', 	rarity:'epique',    cat:'casque',    	tier:2, lvl:13, 	img:"", 							stats:{sante:[32,37], defense:[3.7,4]}, classes:['assassin'] },
  { id:'plastron_necro_assa',   		name:"Plastron du Nécromancien",       	set:'necro_assa', 	rarity:'epique',    cat:'plastron',  	tier:2, lvl:13, 	img:"", 						stats:{sante:[35,41.15], defense:[4.27,4.5], 'Emplacement de Runes':2}, classes:['assassin'] },
  { id:'jambieres_necro_assa',   		name:"Jambières du Nécromancien",      	set:'necro_assa', 	rarity:'epique',    cat:'jambières', 	tier:2, lvl:13, 	img:"", 							stats:{sante:[33,37.2], defense:[3.8,4.2]}, classes:['assassin'] },
  { id:'bottes_necro_assa',     		name:"Bottes du Nécromancien",          set:'necro_assa', 	rarity:'epique',    cat:'bottes',    	tier:2, lvl:13, 	img:"", 								stats:{sante:[30,35.42], defense:3.5}, classes:['assassin'] },
  { id:'casque_chasseuse',     			name:"Casque de la chasseuse",         	set:'abeille_arch', rarity:'rare',    	cat:'casque',    	tier:2, lvl:11, 	img:"", 							stats:{sante:[26,31], defense:[3.2,3.5]}, classes:['archer'] },
  { id:'plastron_chasseuse',   			name:"Plastron de la chasseuse",       	set:'abeille_arch', rarity:'rare',    	cat:'plastron',  	tier:2, lvl:11, 	img:"", 						stats:{sante:[35,40], defense:[4.1,4.5], 'Emplacement de Runes':1}, classes:['archer'] },
  { id:'jambieres_chasseuse',   		name:"Jambières de la chasseuse",      	set:'abeille_arch', rarity:'rare',    	cat:'jambières', 	tier:2, lvl:11, 	img:"", 							stats:{sante:[26.01,29.99], defense:[3.2,3.5]}, classes:['archer'] },
  { id:'bottes_chasseuse',     			name:"Bottes de la chasseuse",          set:'abeille_arch', rarity:'rare',    	cat:'bottes',    	tier:2, lvl:11, 	img:"", 								stats:{sante:[21,27], defense:[2.8,3.2]}, classes:['archer'] },
  { id:'casque_necro_arch',     		name:"Casque du Nécromancien",         	set:'necro_arch', 	rarity:'epique',    cat:'casque',    	tier:2, lvl:13, 	img:"", 							stats:{sante:[29,32], defense:[3.13,3.37]}, classes:['archer'] },
  { id:'plastron_necro_arch',   		name:"Plastron du Nécromancien",       	set:'necro_arch', 	rarity:'epique',    cat:'plastron',  	tier:2, lvl:13, 	img:"", 						stats:{sante:[41,44], defense:[4.6,5.06], 'Emplacement de Runes':2}, classes:['archer'] },
  { id:'jambieres_necro_arch',   		name:"Jambières du Nécromancien",      	set:'necro_arch', 	rarity:'epique',    cat:'jambières', 	tier:2, lvl:13, 	img:"", 							stats:{sante:[31,34], defense:[3.6,3.9]}, classes:['archer'] },
  { id:'bottes_necro_arch',     		name:"Bottes du Nécromancien",          set:'necro_arch', 	rarity:'epique',    cat:'bottes',    	tier:2, lvl:13, 	img:"", 								stats:{sante:[28,31], defense:[3.3,3.6]}, classes:['archer'] },
  /* ══ Mage - Shaman ══ */
  /* ══ Palier 1 ══ */
  ...
  /* ══ Palier 2 ══ */
  { id:'casque_miel_cr',     			name:"Casque en Miel Cristallisé",      set:'abeille_mage', rarity:'rare',    	cat:'casque',    	tier:2, lvl:11, 	img:"", 							stats:{sante:[26,31], defense:[3.2,3.5]}, classes:['mage'] },
  { id:'plastron_miel_cr',   			name:"Plastron en Miel Cristallisé",    set:'abeille_mage', rarity:'rare',    	cat:'plastron',  	tier:2, lvl:11, 	img:"", 						stats:{sante:[35,40], defense:[4.1,4.5], 'Emplacement de Runes':1}, classes:['mage'] },
  { id:'jambieres_miel_cr',   			name:"Jambières en Miel Cristallisé",   set:'abeille_mage', rarity:'rare',    	cat:'jambières', 	tier:2, lvl:11, 	img:"", 							stats:{sante:[26.01,29.99], defense:[3.2,3.5]}, classes:['mage'] },
  { id:'bottes_miel_cr',     			name:"Bottes en Miel Cristallisé",      set:'abeille_mage', rarity:'rare',    	cat:'bottes',    	tier:2, lvl:11, 	img:"", 								stats:{sante:[21,27], defense:[2.8,3.2]}, classes:['mage'] },
  { id:'casque_necro_mage',     		name:"Casque du Nécromancien",         	set:'necro_mage', 	rarity:'epique',    cat:'casque',    	tier:2, lvl:13, 	img:"", 							stats:{sante:[29,32], defense:[3.13,3.37]}, classes:['mage'] },
  { id:'plastron_necro_mage',   		name:"Plastron du Nécromancien",       	set:'necro_mage', 	rarity:'epique',    cat:'plastron',  	tier:2, lvl:13, 	img:"", 						stats:{sante:[41,44], defense:[4.6,5.06], 'Emplacement de Runes':2}, classes:['mage'] },
  { id:'jambieres_necro_mage',   		name:"Jambières du Nécromancien",      	set:'necro_mage', 	rarity:'epique',    cat:'jambières', 	tier:2, lvl:13, 	img:"", 							stats:{sante:[31,34], defense:[3.6,3.9]}, classes:['mage'] },
  { id:'bottes_necro_mage',     		name:"Bottes du Nécromancien",          set:'necro_mage', 	rarity:'epique',    cat:'bottes',    	tier:2, lvl:13, 	img:"", 								stats:{sante:[28,31], defense:[3.3,3.6]}, classes:['mage'] },
  { id:'casque_miel_my',     			name:"Casque de la Miel Mysticisé",     set:'abeille_sham', rarity:'rare',    	cat:'casque',    	tier:2, lvl:11, 	img:"", 							stats:{sante:[26,31], defense:[3.2,3.5]}, classes:['shaman'] },
  { id:'plastron_miel_my',   			name:"Plastron de la Miel Mysticisé",   set:'abeille_sham', rarity:'rare',    	cat:'plastron',  	tier:2, lvl:11, 	img:"", 						stats:{sante:[35,40], defense:[4.1,4.5], 'Emplacement de Runes':1}, classes:['shaman'] },
  { id:'jambieres_miel_my',   			name:"Jambières de la Miel Mysticisé",  set:'abeille_sham', rarity:'rare',    	cat:'jambières', 	tier:2, lvl:11, 	img:"", 							stats:{sante:[26.01,29.99], defense:[3.2,3.5]}, classes:['shaman'] },
  { id:'bottes_miel_my',     			name:"Bottes de la Miel Mysticisé",     set:'abeille_sham', rarity:'rare',    	cat:'bottes',    	tier:2, lvl:11, 	img:"", 								stats:{sante:[21,27], defense:[2.8,3.2]}, classes:['shaman'] },
  { id:'casque_necro_sham',     		name:"Casque du Nécromancien",         	set:'necro_sham', 	rarity:'epique',    cat:'casque',    	tier:2, lvl:13, 	img:"", 							stats:{sante:[29,32], defense:[3.13,3.37]}, classes:['shaman'] },
  { id:'plastron_necro_sham',   		name:"Plastron du Nécromancien",       	set:'necro_sham', 	rarity:'epique',    cat:'plastron',  	tier:2, lvl:13, 	img:"", 						stats:{sante:[41,44], defense:[4.6,5.06], 'Emplacement de Runes':2}, classes:['shaman'] },
  { id:'jambieres_necro_sham',   		name:"Jambières du Nécromancien",      	set:'necro_sham', 	rarity:'epique',    cat:'jambières', 	tier:2, lvl:13, 	img:"", 							stats:{sante:[31,34], defense:[3.6,3.9]}, classes:['shaman'] },
  { id:'bottes_necro_sham',     		name:"Bottes du Nécromancien",          set:'necro_sham', 	rarity:'epique',    cat:'bottes',    	tier:2, lvl:13, 	img:"", 								stats:{sante:[28,31], defense:[3.3,3.6]}, classes:['shaman'] },
  /* ══ Other ══ */
