...
const ITEMS = [
  ...
  { id:'spectre_hivernal_sha', 			name:"Scpetre Hivernale",               rarity:'',  		cat:'arme_p',  tier:0, lvl:10, img:"../img/compendium/textures/weapons/events/staff_christmas.png",                  					stats:{degats:25, vitesse_attaque:1, soin_bonus:6}, classes:['shaman'] },
  /* ══ Catalyseurs ══ */
  ...
  { id:'anneau_onyx_impur',     		name:"Anneau d'Onyx Impur",            	set:'onyx_impur',   rarity:'epique',   	cat:'anneau',    	tier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Anneau d'Onyx Impur.png",                     	stats:{crit_chance:1, defense:1.5, sante:10} },
  { id:'anneau_winnie',     			name:"Anneau de Winnie",           		set:'ours',   		rarity:'mythique',  cat:'anneau',    	tier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set des Ours/Bague de Winnie.png",                     			stats:{crit_chance:5, crit_comp_chance:5, reduction_degats:2.5, sante:10} },
  { id:'anneau_onyx_pur',     			name:"Anneau d'Onyx Pur",            	set:'onyx_pur',   	rarity:'legendaire',cat:'anneau',    	tier:2, lvl:14, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Anneau d'Onyx Pur.png",                     		stats:{crit_chance:2, crit_degats:1, defense:1, sante:20} },
  /* ══ Events ══ */
  { id:'anneau_amour',    				name:"Anneau d'Amour",          			    			rarity:'',   	 	cat:'anneau',     	tier:0, lvl:10, img:"../img/compendium/textures/trinkets/Valentin/Anneau d'Amour.png",                        				stats:{crit_chance:5, crit_degats:5, crit_comp_chance:5, crit_comp_degats:5, sante:15} },
  /* ══ Amulettes ══ */
  /* ══ Palier 1 ══ */
  ...
  { id:'amulette_onyx_impur', 	 		name:"Amulette d'Onyx Impur", 	 		set:'onyx_impur', 	rarity:'epique',    cat:'amulette',  	tier:2, lvl:13,  img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Amulette d'Onyx Impur.png",      				stats:{defense:2, sante:15} },
  { id:'amulette_onyx_pur', 	 		name:"Amulette d'Onyx Pur", 	 		set:'onyx_pur', 	rarity:'legendaire',cat:'amulette',  	tier:2, lvl:14,  img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Amulette d'Onyx Pur.png",      					stats:{defense:2, sante:20} },
  /* ══ Events ══ */
  ...
  { id:'gants_onyx_impur',       		name:"Gants d'Onyx Impur",             	set:'onyx_impur',	rarity:'epique',   	cat:'gants',     	tier:2, lvl:13,  img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Gants d'Onyx Impur.png",                     	stats:{degats:2.5, crit_chance:3, defense:1} },
  { id:'gants_onyx_pur',       			name:"Gants d'Onyx Pur",             	set:'onyx_pur',		rarity:'legendaire',cat:'gants',     	tier:2, lvl:14,  img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Gants d'Onyx Pur.png",                     		stats:{degats:2.5, crit_chance:3, defense:1} },
  /* ══ Events ══ */
  { id:'moufles_noel_vertes',    		name:"Moufles de Noël Vertes",          			    	rarity:'',   	 	cat:'gants',     	tier:0, lvl:10, img:"../img/compendium/textures/trinkets/Christmas/gants_noel_vert.png",                        			stats:{esquive:10, soin_bonus:5, sante:5, regen_sante:0.3, regen_mana:0.4, regen_stamina:0.2} },
  /* ══ Bracelets ══ */
  /* ══ Palier 1 ══ */
  ...
  { id:'bracelet_onyx_impur',  			name:"Bracelet d'Onyx Impur",          	set:'onyx_impur',   rarity:'epique',    cat:'bracelet',		tier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Bracelet d'Onyx Impur.png",                    stats:{defense:2, sante:15, regen_sante:0.1} },
  { id:'bracelet_onyx_pur',  			name:"Bracelet d'Onyx Pur",          	set:'onyx_pur',    	rarity:'legendaire',cat:'bracelet',		tier:2, lvl:14, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Bracelet d'Onyx Pur.png",                    	stats:{defense:2, sante:20, regen_sante:0.2} },
  /* ══ Events ══ */
  { id:'bracelet_yuleck',    			name:"Bracelet de Yuleck",          			    		rarity:'',   	 	cat:'bracelet',     tier:0, lvl:10, img:"../img/compendium/textures/trinkets/Christmas/bracelet_yuleck.png",                        			stats:{soin_bonus:2, sante:7, regen_sante:0.3, vitesse_deplacement:-0.5} },
  /* ══ Artefacts ══ */
  ...
  { id:'piece_onyx_impur',  			name:"Pièce d'Onyx Impur",             	set:'onyx_impur',   rarity:'epique',   	cat:'artefact',		tier:2, lvl:13, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Impur/Pièce d'Onyx Impur.png",                       stats:{crit_chance:3, crit_degats:1.5, defense:2.5, sante:13} },
  ...
  { id:'piece_onyx_pur',  				name:"Pièce d'Onyx Pur",              	set:'onyx_pur',    	rarity:'legendaire',cat:'artefact',		tier:2, lvl:14, img:"../img/compendium/textures/trinkets/P2/Set d'Onyx Pur/Pièce d'Onyx Pur.png",                       	stats:{crit_chance:4, crit_degats:2, defense:3, sante:15} },
  { id:'masque_corrompu',  				name:"Masque Corrompu",              	set:'faible_corru', rarity:'godlike',	cat:'artefact',		tier:2, lvl:14, img:"../img/compendium/textures/trinkets/P2/Masque Corrompu.png",                       					stats:{crit_chance:10, crit_degats:10, crit_comp_chance:10, crit_comp_degats:10, degats_arme:10, degats_competence:10, sante:-50} },
  /* ══ Events ══ */
